...
function 	HaceBotones() {		//	Preparar los botones
	...
	menuBtn.style.top = (STAGE_Y-BLOCK_CELL_SIZE)+"px";
	...
	giraPieza.style.top = (STAGE_Y-BLOCK_CELL_SIZE)+"px";
	...
	volteaPieza.style.top =  (STAGE_Y-BLOCK_CELL_SIZE)+"px";
	...
	hintBtn.style.top = (STAGE_Y-BLOCK_CELL_SIZE)+"px";
	hintBtn.style.position = "absolute";


	//	checkBtn = document.createElement("check");
	//	checkBtn.setAttribute("type", "checkbox");
	//	checkBtn.label = "checkbox";
	//	checkBtn.value = nProblema;
...
//	nroProbBtn boton aceptar numero de problema
	...
	nroProbBtn.style.left			=	STAGE_OFFSET_X + "050px";	
...
function initScreenVariable()
{
	...
	var maxStageX = 1200;
	var maxStageY = 840;				//	2/3
	var maxCellSize = 64;
	
	var midStageX = 800;
	var midStageY = 560;				//	3/4
	var midCellSize = 50;				//	var midCellSize = 32;
	
	var miniStageX = 600;
	var miniStageY = 420;				//	2/3
	var miniCellSize = 36;			// 24;
	
	var microStageX = 400;		
	var microStageY = 280;			//	3/4
	var microCellSize = 24;			// 20;
	...
	//	let nRel = SCREEN_X / SCREEN_Y;
		...
		//			STAGE_X = Math.floor(1.25 * STAGE_Y);
		//		}
...
function initScreenPosColor()
{
	...
	document.getElementById('check').style.cssText = 
		"top:" + (STAGE_Y- 40)+ "px; left:" + (13.2 * BLOCK_CELL_SIZE) + "px; position: absolute; font:" + (16) + "px roboto white";
	//	checkBtn.style.left = 13.2 * BLOCK_CELL_SIZE;
	//	checkBtn.style.top = (STAGE_Y-BLOCK_CELL_SIZE)+"px";
	//	checkBtn.style.height		= 0.6 * BLOCK_CELL_SIZE;
	//	checkBtn.style.position = "absolute";
...
function HaceInitLayer()  {//pantalla de inicio
	...
	if (DEBUG)	{
		var debugTxt = new Kinetic.Text({
			...
			text: 'SCREEN_X, SCREEN_Y, gStage...(): ' + SCREEN_X + ', ' + SCREEN_Y+ ', ' + gStage.getHeight()+ ', ' + gStage.getWidth(),  //	ancho y alto de pantalla en px
			fontSize: 24,//130,
